        ...
        <div className="mt-5">
            ...
            <div class={`collapse`} id="commit">
                <div class={`card card-body ${seletor_result['bg']} ${seletor_result['tc']}`}>
                    ...
                    <span><i className="fa fa-file-text" aria-hidden="true"></i> Mensagem: {commit_result.commit.message}</span>
                    <span><i className="fa fa-male" aria-hidden="true"></i> Autor: {commit_result.committer.name}</span>
                    <span><i className="fa fa-tree" aria-hidden="true"></i> Branch: {commit_result.name}</span>
                    <span><i className="fa fa-calendar" aria-hidden="true"></i> Data: {commit_result.commit.committer.date}</span>
